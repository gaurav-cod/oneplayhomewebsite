...
tabs.forEach(tab => {
    ...
    subscriptions.forEach(sub=>{
        ...
        if (sub?.tab_label === 'Monthly') {
            ...
            ${sub['plan_config']?.is_sold_out ? 
                        `<span class="discount text-sold-out">${currencyMap[sub['currency']] || sub['currency']} ${sub?.actual_price}</span>
                        <span class="price text-sold-out">${currencyMap[sub['currency']] || sub['currency']} ${sub['plan_config']?.value}</span>
                        ...
                        `<span class="discount fontCustom">${currencyMap[sub['currency']] || sub['currency']} ${sub?.actual_price}</span>
                        <span class="price text-white">${currencyMap[sub['currency']] || sub['currency']} ${sub['plan_config']?.value}</span>
...
: ''}
            <div class="row">
              ...
              ${sub['plan_config']?.is_sold_out ?`<span class="discount text-sold-out">${currencyMap[sub['currency']] || sub['currency']} ${sub?.actual_price}</span>
                <span class="price text-sold-out">${currencyMap[sub['currency']] || sub['currency']} ${sub['plan_config']?.value}</span>
                <div class="img-container">
